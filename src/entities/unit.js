...
/* ====================== CREATE ====================== */
/**
 * Создать помещение в рамках проекта.
 * Проверяет наличие дубликатов по названию и проекту,
 * затем возвращает сохранённую запись.
 */
...
/**
 * Обновить помещение.
 * Предотвращает дублирование номера внутри проекта
 * и возвращает актуальную запись.
 */
